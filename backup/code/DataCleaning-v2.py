...
def imputation(df, fillna_cols=None):
    ...
    Args:
        ...
        fillna_cols (`fillna_cols`): Columns that need to be imputated. Defaults to None
    Returns:
...
def create_text_column(df, text_cols=None):
    ...
    Args:
        ...
        text_cols (`text_cols`): Columns that need to be combined. Defaults to None
    Returns:
...
create_text_column(data, text_cols)
